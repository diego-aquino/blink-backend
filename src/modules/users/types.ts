...
export type CreateUserBadRequestResponseBody = BlinkOperations['users/create']['response']['400']['body'];
...
export type UpdateUserBadRequestResponseBody = BlinkOperations['users/update']['response']['400']['body'];
